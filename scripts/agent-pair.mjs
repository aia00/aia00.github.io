...
function buildWriterPrompt({
    ...
    return [
        ...
        '- Any blog post content you create or revise must be written in English unless the user explicitly asks for another language.',
...
function buildCodeReviewerPrompt({
    ...
    return [
        ...
        '- For any blog post content touched in this round, require the published prose to be in English unless the user explicitly asked for another language. Mixed-language or primarily non-English blog prose is a blocking issue.',
